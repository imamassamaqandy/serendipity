...
if( ! function_exists( 'cs_framework_init' ) && ! class_exists( 'CSFramework' ) ) {
  function cs_framework_init() {
    ...
    // configs
    cs_locate_template( '../theme-options/framework.config.php'  );
    cs_locate_template( '../theme-options/metabox.config.php'    );
    cs_locate_template( '../theme-options/taxonomy.config.php'   );
    cs_locate_template( '../theme-options/shortcode.config.php'  );
    cs_locate_template( '../theme-options/customize.config.php'  );
