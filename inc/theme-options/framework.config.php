...
$options[]      = array(
  ...
  'fields'      => array(
    ...
    'help'    => 'Upload a background for Section 1.',
    ),

    array(
      'id'      => 'section_1_contents',
      'type'    => 'textarea',
      'title'   => 'Section 1 Contents',
      'help'    => 'Fill your Section 1 contents.',
    ),
    ...
    'help'    => 'Upload a background for Section 2.',
    ),

    array(
      'id'      => 'section_2_contents',
      'type'    => 'textarea',
      'title'   => 'Section 2 Contents',
      'help'    => 'Fill your Section 2 contents.',
    ),
    ...
    'help'    => 'Upload a background for Section 3.',
    ),

    array(
      'id'      => 'section_3_contents',
      'type'    => 'textarea',
      'title'   => 'Section 3 Contents',
      'help'    => 'Fill your Section 3 contents.',
    ),
    ...
    'id'      => 'section_4_bg',
    'type'    => 'upload',
    'title'   => 'Section 4 Background',
    'help'    => 'Upload a background for Section 4.',
    ),

    array(
      'id'      => 'section_4_contents',
      'type'    => 'textarea',
      'title'   => 'Section 4 Contents',
      'help'    => 'Fill your Section 4 contents.',
    ),
